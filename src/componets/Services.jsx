    ...
    <section className="bg-white py-16">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 mx-auto md:grid-cols-2 lg:grid-cols-3 gap-8">
         ...
         <Link to="/contact">
         <div class="md:w-[300px] w-[100%] flex md:flex-col rounded-md border items-center bg-green-200 text-center transition duration-500 ease-in-out transform hover:bg-gradient-to-r from-green-500 to-green-300 hover:scale-105 shadow-2xl">
            <img
              src={webDesign}
              alt="Laptop"
